...
public class CrimeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View layout = inflater.inflate(R.layout.fragment_crime, container, false);

        floatingActionMenu = (FloatingActionMenu) getActivity().findViewById(R.id.floatingActionMenu);
        recyclerView = (RecyclerView) layout.findViewById(R.id.missingPersonRecyclerViewCrimeFragment);
